...
export default class qreditApi {
    apiURL: string;
    ...
    public getBlockHeight() {
        return new Promise((resolve, reject) => {
            axios.get(this.apiURL + '/blocks?limit=1').then(body => {
                var result = body.data;
                if (result && result.data && result.data[0].height && result.data[0].id)
                    resolve(result.data[0].height);
                else
                    reject('No Data');
    ...
    // public listBlocks = function (page, limit, id, height, orderBy) {
    ...
    // public getBlockByHeight = function (height) {
    //     /*
    //         (REQUIRED)
    ...
    // public getBlockByID = function (id) {
    //     /*
    //         (REQUIRED)
    ...
    // public getTransactionsByBlockID = function (id) {
    //     /*     
    ...
    // public searchBlocks = function (page, limit, body) {
    ...
    // public listDelegates = function (page, limit, orderBy) {
    ...
    // public getDelegate = function (identifier) {
    ...
    // public getDelegateBlocks = function (identifier, page, limit) {
    ...
    // public getDelegateVoters = function (identifier, page, limit) {
    ...
    // public searchDelegates = function (page, limit, body) {
    ...
    // public getPeers = function (page, limit, port, status, os, version, orderBy) {
    ...
    // public getPeerByIP = function (ip) {
    ...
    // public createTransaction = function (transactions) {
    ...
    // public getTransactionByID = function (id) {
    ...
    // public listTransactions = function (page, limit, type, blockId, id, orderBy) {
    ...
    // public listUnconfirmedTransactions = function (page, limit) {
    ...
    // public getUnconfirmedTransactionByID = function (id) {
    ...
    // public searchTransactions = function (page, limit, body) {
    ...
    // public listVotes = function (page, limit, orderBy) {
    ...
    // public getVoteByID = function (id) {
    ...
    // public listWallets = function (page, limit, orderBy) {
    ...
    // public getWalletByID = function (id) {
    ...
    // public getWalletBalance = function (id) {
    ...
    // public getWalletTransactions = function (id, page, limit) {
    ...
    // public getWalletReceivedTransactions = function (id, page, limit) {
    ...
    // public getWalletSentTransactions = function (id, page, limit) {
    ...
    // public getWalletVotes = function (id, page, limit) {
    ...
    // public getTopWallets = function (page, limit) {
    ...
    // public searchWallets = function (page, limit, body) {
